...
if __name__ == "__main__":
    ...
    experiment_settings = {
    "experiment_name": "experiment2RandTargetShuffle",
    "buffers": ["0","250","500"],
    "windows": ["1","2","3"],
    ...
    "search_length": 1000,
    "seed": 3789,
    "experiment_description": "Experiment2"
    }
    ...
    for buffer_size in experiment_settings['buffers']:
        for window_size in experiment_settings['windows']:
            ...
            # Prepare Data
            #base_dir = "/home/exx/caleb/familiarity/feature-genYoked/Features"
