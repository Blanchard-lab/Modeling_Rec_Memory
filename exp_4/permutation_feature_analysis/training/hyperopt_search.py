...
class HyperoptSearch:
    ...
    def __get_classifier_instance(self, model_name, model_params):
        ...
        if model_name == 'naive_bayes':
            ...
            return LinearSVC(**model_params, class_weight=self.class_weight_dict, random_state=model_seed)
        elif model_name == 'decision_tree':
            return DecisionTreeClassifier(**model_params, class_weight=self.class_weight_dict,
                                          random_state=model_seed)
        elif model_name == 'randomforest':
            return RandomForestClassifier(**model_params, class_weight=self.class_weight_dict,
                                          random_state=model_seed)
        elif model_name == 'knn':
            return KNeighborsClassifier(**model_params)
        elif model_name == 'logistic_regression':
            return LogisticRegression(**model_params, class_weight=self.class_weight_dict,
                                      random_state=model_seed)
        elif model_name == 'SVC':
            return SVC(**model_params, probability=True, class_weight=self.class_weight_dict,
                       random_state=model_seed)
        elif model_name == 'SVM':
            return svm.SVC(**model_params, gamma='auto', probability=True, class_weight=self.class_weight_dict,
                           random_state=model_seed)
        else:
            return 0
